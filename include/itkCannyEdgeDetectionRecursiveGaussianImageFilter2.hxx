/*=========================================================================
  ...
  Module:    itkCannyEdgeDetectionRecursiveGaussianImageFilter2.hxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __itkCannyEdgeDetectionRecursiveGaussianImageFilter_hxx
#define __itkCannyEdgeDetectionRecursiveGaussianImageFilter_hxx
...
::GenerateData()
{
  ...
  // TODO fixme.. Fix the laplacian filter to be able to take in 
  // non-isotropic sigmas
  m_LaplacianFilter->SetSigma( this->m_Sigma[0] );
