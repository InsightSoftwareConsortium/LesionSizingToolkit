/*=========================================================================
  ...
  Module:    itkVectorSparseFieldLevelSetImageFilter.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __itkVectorSparseFieldLevelSetImageFilter_h
#define __itkVectorSparseFieldLevelSetImageFilter_h
 ...
 * A data structure used in the VectorSparseFieldLevelSetImageFilter to construct
...
/**
 *  \class VectorSparseFieldLevelSetImageFilter
 *
...
public:
  ...
  typedef VectorFiniteDifferenceImageFilter<
  ...
  typedef typename NumericTraits< ValueType >::ScalarRealType   ScalarValueType;
...
private:
  VectorSparseFieldLevelSetImageFilter(const Self&);//purposely not implemented
...
#include "itkVectorSparseFieldLevelSetImageFilter.txx"
#endif
