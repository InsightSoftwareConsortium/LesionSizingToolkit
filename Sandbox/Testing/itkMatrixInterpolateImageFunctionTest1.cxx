...
int main( int argc, char * argv [] )
{
  ...
  typedef itk::MatrixInterpolateImageFunction< ImageType1 >  InterpolatorType1;
  typedef itk::MatrixInterpolateImageFunction< ImageType2 >  InterpolatorType2;
  typedef itk::MatrixInterpolateImageFunction< ImageType3 >  InterpolatorType3;
