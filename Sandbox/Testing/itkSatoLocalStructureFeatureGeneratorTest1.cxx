...
int main( int argc, char * argv [] )
{
  ...
  typedef itk::SatoLocalStructureFeatureGenerator< Dimension >   SatoLocalStructureFeatureGeneratorType;
  typedef SatoLocalStructureFeatureGeneratorType::SpatialObjectType    SpatialObjectType;
