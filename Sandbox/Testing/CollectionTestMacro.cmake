...
#
MACRO(SCREEN_SHOT DATASET_OBJECT_ID ISO_VALUE CONTOUR_ID)
...
MACRO(SCREEN_SHOT_FEATURES DATASET_OBJECT_ID)

IF( LSTK_SANDBOX_USE_VTK )

# Screen shots of feature generators
SCREEN_SHOT( ${DATASET_OBJECT_ID} 0.5 GMSFG )
SCREEN_SHOT( ${DATASET_OBJECT_ID} 0.5 SFG )
SCREEN_SHOT( ${DATASET_OBJECT_ID} 0.5 LWFG )
SCREEN_SHOT( ${DATASET_OBJECT_ID} 0.5 MOFG )
SCREEN_SHOT( ${DATASET_OBJECT_ID} 0.5 SVFG )
SCREEN_SHOT( ${DATASET_OBJECT_ID} 0.5 SVSFG )
SCREEN_SHOT( ${DATASET_OBJECT_ID} 0.5 SLSFG )
SCREEN_SHOT( ${DATASET_OBJECT_ID} 0.5 DSFG )
SCREEN_SHOT( ${DATASET_OBJECT_ID} 0.5 FTFG )
...
SCREEN_SHOT( ${DATASET_OBJECT_ID}  0.0   LSMT3 )
SCREEN_SHOT( ${DATASET_OBJECT_ID}  0.0   LSMT4 )
SCREEN_SHOT( ${DATASET_OBJECT_ID}  0.0   LSMT5 )
SCREEN_SHOT( ${DATASET_OBJECT_ID}  0.0   LSMT6 )
SCREEN_SHOT( ${DATASET_OBJECT_ID}  0.0   LSMT7 )
SCREEN_SHOT( ${DATASET_OBJECT_ID}  0.0   LSMT8 )
