...
MACRO(VOLUME_ESTIMATION_B DATASET_ID OBJECT_ID SEGMENTATION_METHOD_ID)
SET(DATASET_OBJECT_ID ${DATASET_ID}_${OBJECT_ID})
SET(ISO_VALUE 0.0)
ADD_TEST(LSMTVEB${SEGMENTATION_METHOD_ID}_${DATASET_OBJECT_ID}
  ...
  ${TEMP}/LSMT${SEGMENTATION_METHOD_ID}_Test${DATASET_OBJECT_ID}.mha
  ${ISO_VALUE}
  ${TEMP}/LSMT${SEGMENTATION_METHOD_ID}_Test${DATASET_OBJECT_ID}.vtk
  LSMT${SEGMENTATION_METHOD_ID}
  ${DATASET_ID}
...
VOLUME_ESTIMATION_B( ${DATASET_ID} ${OBJECT_ID} 3 )
VOLUME_ESTIMATION_B( ${DATASET_ID} ${OBJECT_ID} 4 )
VOLUME_ESTIMATION_B( ${DATASET_ID} ${OBJECT_ID} 5 )
VOLUME_ESTIMATION_B( ${DATASET_ID} ${OBJECT_ID} 6 )
VOLUME_ESTIMATION_B( ${DATASET_ID} ${OBJECT_ID} 7 )
VOLUME_ESTIMATION_B( ${DATASET_ID} ${OBJECT_ID} 8 )
VOLUME_ESTIMATION_B( ${DATASET_ID} ${OBJECT_ID} 9 )
